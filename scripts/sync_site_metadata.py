...
PAGES = {
    ...
    "pay-consultation": {
        "file": ROOT / "pay-consultation" / "index.html",
        ...
        "keywords": ["redirect", "payments", "consultation", "ASH-TRA"],
        "social_filename": "ash-tra-redirect-payments-social-preview.png",
        "social_label": "Redirect",
        "social_title": "Redirecting to the consultation payments page",
        "social_body": "This legacy route now forwards to the live payments page for the paid consultation path.",
        "social_chips": ["Redirect", "Payments", "Consultation"],
        "accent": ("#FFB184", "#79E3FF"),
        "page_type": "WebPage",
        "schema_kind": "redirect",
        "indexable": False,
        "robots": "noindex,follow",
        "canonical": "https://ash-tra.com/payments/",
        "redirect_target": "../payments/",
    },
    "schedule-meeting": {
        "file": ROOT / "schedule-meeting" / "index.html",
        ...
        "keywords": ["redirect", "schedule", "consultation", "ASH-TRA"],
        "social_filename": "ash-tra-redirect-schedule-social-preview.png",
        "social_label": "Redirect",
        "social_title": "Redirecting to the consultation schedule page",
        "social_body": "This legacy route now forwards to the live schedule page for booking the consultation call.",
        "social_chips": ["Redirect", "Schedule", "Consultation"],
        "accent": ("#79E3FF", "#8C91FF"),
        "page_type": "WebPage",
        "schema_kind": "redirect",
        "indexable": False,
        "robots": "noindex,follow",
        "canonical": "https://ash-tra.com/schedule/",
        "redirect_target": "../schedule/",
    },
    "start-project": {
        "file": ROOT / "start-project" / "index.html",
        "path": "/start-project/",
        "title": "Redirecting to Project Launch | ASH-TRA",
        "description": "This route now redirects to the project launch page.",
        "keywords": ["redirect", "launch", "project intake", "ASH-TRA"],
        "social_filename": "ash-tra-redirect-launch-social-preview.png",
        "social_label": "Redirect",
        "social_title": "Redirecting to the project launch page",
        "social_body": "This legacy route now forwards to the live launch intake page for starting a new project.",
        "social_chips": ["Redirect", "Launch", "Project"],
        "accent": ("#FFB184", "#79E3FF"),
        "page_type": "WebPage",
        "schema_kind": "redirect",
        "indexable": False,
        "robots": "noindex,follow",
        "canonical": "https://ash-tra.com/launch/",
        "redirect_target": "../launch/",
    },
}
